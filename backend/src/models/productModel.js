...
const Product = {
  async create(productData) {
    ...
    return { id: result.insertId, title, category, price, description, status }; 
  },
  ...
  async findAll(filters = {}) {
    let baseSelectSql = 'SELECT id, title, category, price, description, status, created_at, updated_at FROM products'; 
